...
(function(f) {
    ...
    var m = f.fn.dataTable,
        n = function(a, b) {
            ...
            this.c = f.extend(!0, {}, m.defaults.keyTable,
                n.defaults, b);
            this.s = {
                dt: new m.Api(a),
                enable: !0,
    ...
    f.extend(n.prototype, {
        ...
        _clipboard: function() {
            ...
            k.getSelection && (f(h).on("copy.keyTable", function(a) {
                ...
                var c = c.originalEvent,
                    ...
                    f = b.c.editor,
                    g;
                if (d && (!e || "body" === e.nodeName.toLowerCase())) c.preventDefault(), k.clipboardData && k.clipboardData.getData ? g = k.clipboardData.getData("Text") : c.clipboardData && c.clipboardData.getData && (g = c.clipboardData.getData("text/plain")), f ? f.inline(d.cell.index()).set(f.displayed()[0],
        ...
        _editor: function(a, b) {
            var c = this,
                d = this.s.dt,
                e = this.c.editor;
            if (!f("div.DTE", this.s.lastFocus.cell.node()).length && !(0 <= a && 9 >= a || 11 === a || 12 === a || 14 <= a && 31 >= a || 112 <= a && 123 >= a || 127 <= a && 159 >= a)) {
                b.stopPropagation();
                ...
                if (13 === a) f(h).one("keyup", function() {
                    l()
                });
                else l()
            }
        ...
        _focus: function(a, b, c, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, l.one("draw", function() {
                    e.s.focusDraw = !1;
                    ...
                    if (c === o || !0 === c) this._scroll(f(k), f(h.body), i, "offset"), c = l.table().body().parentNode, c !== l.table().header().parentNode && (c = f(c.parentNode), this._scroll(c, c, i, "position"));
                    this.s.lastFocus = {
                        cell: g,
                        node: g.node(),
                        relative: {
        ...
        _key: function(a) {
            if (this.s.waitingForDraw) a.preventDefault();
                ...
                if (b && (!(0 === a.keyCode || a.ctrlKey || a.metaKey || a.altKey) || a.ctrlKey && a.altKey) && this.s.lastFocus) {
                    ...
                    if (!(this.c.keys && -1 === f.inArray(a.keyCode,
        ...
        _updateFixedColumns: function(a) {
            ...
            if (c._oFixedColumns) {
                var d =
                    c.aoColumns.length - c._oFixedColumns.s.iRightColumns;
    ...
    m.ext.selector.cell.push(function(a, b, c) {
        var b = b.focused,
            ...
            d = [];
        if (!a || b === o) return c;
        for (var e = 0, f = c.length; e < f; e++)(!0 ===
            b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]);
        return d
    });
