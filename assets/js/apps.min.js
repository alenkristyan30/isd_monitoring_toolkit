    ...
    handleUnlimitedTabsRender = function() {
        function a(e, a) {
            ...
            switch ($(t).find("li").each(function() {
                ...
                case "prev":
                    var r;
                    (r = -o) <= i ? ($(t).removeClass("overflow-left"), l = 0) : l = r - i + 80, $("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({
                        marginRight: "-" + l + "px"
                    }, 150, function() {
    ...
    handleUnlimitedTopMenuRender = function() {
        ...
        function a(e, a) {
            ...
            switch ($(t).find("li").each(function() {
                ...
                case "prev":
                    var r;
                    (r = -o) <= i ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), l = 0) : l = r - i + 88, $("body").hasClass("rtl-mode") ? $(t).animate({
                        marginRight: "-" + l + "px"
                    }, 150, function() {
