...
<div class="row">
  <div class="col-lg-2">
    <p class="m-b-20">
      <a href="#myModal" class="btn btn-sm btn-primary" data-toggle="modal" id="btnadd">Add Office</a>
    </p>
  </div>
</div>
  ...
  <div class="col-lg-6 ui-sortable">
    <div class="panel panel-inverse">
      ...
      <div class="panel-heading">
        ...
        <h4 class="panel-title">Office</h4>
      </div>

      <div class="panel-body table-responsive">
        <table id="myoffice" class="table w-100">
          <thead>
            <tr>
              <th>ID</th>
              <th>NAME</th>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group row m-b-15" id="officeidform">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control numeric" id="officeidtxt" name="officeidtxt" placeholder="ID" >
                  </div>
                </div>

                <div class="form-group row m-b-15" id="officenameform">
                  <label for="officenametxt" class="col-md-3 col-sm-3 col-form-label">Name</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control alphabetic" id="officenametxt" name="officenametxt" placeholder="Name" >
                  </div>
                </div>
