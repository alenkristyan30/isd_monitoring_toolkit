...
<div class="row">
  <div class="col-lg-2">
    <p class="m-b-20">
      <a href="#myModal" class="btn btn-sm btn-primary" data-toggle="modal" id="btnadd">Add Position</a>
    </p>
  </div>
  ...
  <div class="col-lg-6 ui-sortable">
    <div class="panel panel-inverse">
      ...
      <div class="panel-body table-responsive">
        <table id="myposition" class="table w-100">
          <thead>
            <tr>
              <th>ID</th>
              <th>NAME</th>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group row m-b-15" id="positionnameform">
                  <label for="positionnametxt" class="col-sm-3 text-left control-label">Name</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="positionnametxt" name="positionnametxt" placeholder="Name" required>
                  </div>
                </div>
                <div class="form-group row m-b-15" id="positiontypeform">
                  <label for="positiontypetxt" class="col-sm-3 text-left control-label">Type</label>
                  <div class="col-sm-8">
