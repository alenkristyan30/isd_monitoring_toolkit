      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal form-control-line" id="vform" onsubmit="return validate()" method="POST" novalidate>
            ...
            <div class="form-group row" id="unitnameform">
              <label for="unitnametxt" class="col-sm-3 text-left control-label col-form-label">Name</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" id="unitnametxt" name="unitnametxt" placeholder="Name" required>
              </div>
            </div>
            <div class="form-group row" id="unittypeform">
              <label for="unittypetxt" class="col-sm-3 text-left control-label col-form-label">Type</label>
              <div class="col-sm-8">
