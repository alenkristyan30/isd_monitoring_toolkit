<section class="mt-lg-5">
  ...
  <section class="mt-lg-5">
    ...
    <div class="row">
      ...
      <div class="col-xl-6 col-md-6 mb-4">
        <div class="text-left">
          <h3 class="pb-3"><strong>Recent Feedback</strong></h3>
        </div>
        <div class="mb-4">
          <div class="card">
            <div class="card-body">
              <div class="media d-block d-md-flex mt-3">
                <img class="card-img-64 rounded-circle z-depth-0 d-flex mx-auto mb-3" src="../dist/img/male-avatar.png" alt="Generic placeholder image">
